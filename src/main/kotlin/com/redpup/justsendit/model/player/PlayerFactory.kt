...
interface PlayerFactory {
  ...
  fun create(playerCard: PlayerCard, handler: PlayerHandler): MutablePlayer
}
...
object PlayerFactoryImpl : PlayerFactory {
  ...
  private fun ((Player) -> AbilityHandler).createPlayerFunctor(): (PlayerCard, PlayerHandler) -> MutablePlayer {
