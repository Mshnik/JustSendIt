...
class David(override val proto: PlayerCardProto) : PlayerCard {
  override fun handleGameEvent(
      event: PlayerGameEvent,
      player: MutablePlayer,
      gameModel: GameModel,
  ) {
    if (event is PlayerGameEvent.PlayerSkiRide && event.slope.hazardsList.contains(Hazard.HAZARD_TREES)) {
