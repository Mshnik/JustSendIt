...
class CardWidget(val skill: Skill) : VBox() {
  ...
  private val content = VBox(Label("Cost: ${skill.skillCard.cost}"), Label("Rules text goes here..."))
  ...
  init {
    ...
    badge.style = "-fx-background-color: gold; -fx-text-fill: black; -fx-font-weight: bold; -fx-padding: 2; -fx-background-radius: 10;"
  ...
  private fun updateVisualState() {
    if (isSelected) {
        this.style = "-fx-background-color: #ffffcc; -fx-border-color: gold; -fx-border-width: 2; -fx-padding: 5;"
        this.translateY = -12.0
    } else {
        this.style = "-fx-background-color: white; -fx-border-color: black; -fx-border-width: 1; -fx-padding: 5;"
        this.translateY = 0.0
    }
  }
